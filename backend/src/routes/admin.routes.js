...
router.get("/exam-co/:examId", verifyToken, requireRole("admin"), admin.getExamCOAttainment);
router.get("/course-attainment/:courseId", verifyToken, requireRole("admin"), admin.getCourseAttainment);
